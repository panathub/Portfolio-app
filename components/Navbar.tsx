...
export default function Navbar({ }: Props) {
  ...
  const navigation = [
    ...
    { name: 'About', href: '#about', current: activeLink === "about" ? true : false },
    { name: 'Skill', href: '#skill', current: activeLink === "skill" ? true : false },
    { name: 'Contact', href: '#contact', current: activeLink === "contact" ? true : false },
  ]
