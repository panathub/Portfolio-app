...
export default function Contact() {
    return (
        <section id="contact" className="bg-white dark:bg-gray-900">
            <div className="py-8 lg:py-32 px-4 mx-auto max-w-screen-md" data-aos="flip-up" data-aos-duration="1200">
                ...
                <form action="#" className="space-y-8">
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <textarea name="floating_message" rows={6} id="floating_message" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <button type="submit" className="block mx-auto py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-gray-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                </form>
            </div>
        </section>
    )
